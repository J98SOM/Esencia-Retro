...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('factura-vence').value = expires.toISOString().split('T')[0];
...
function guardarFactura() {
    ...
    toast.innerHTML = '<span class="material-symbols-outlined" style="font-variation-settings:\'FILL\' 1;font-size:1.2rem">check_circle</span> Factura guardada exitosamente';
